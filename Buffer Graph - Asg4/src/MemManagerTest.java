...
public class MemManagerTest extends TestCase {
    ...
    public void setUp() throws IOException {
        memTest = new MemManager(32, 10, "testBin");
    }
    //----------------------------------------------------------------------
    /**
    ...
    public void testSetup() throws IOException {        
        assertEquals(memTest.getInitBlockSize(), 32);
...
//        assertEquals(decrypted.substring(26, 35), "Green Day");
     ...
     * @throws IOException 
     */
    public void testInsertAndResize() throws IOException {
        systemOut().clearHistory();
     ...
     * @throws IOException 
     */
    public void testInsertAndRemove() throws IOException {
        systemOut().clearHistory();
    ...
    public void testRemoveAll() throws IOException {
        systemOut().clearHistory();
        MemManager testRemoveAll = new MemManager(10000, 10, "testBin");
