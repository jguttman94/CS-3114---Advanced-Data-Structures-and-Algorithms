...
public class HashTest extends TestCase {
    ...
    public void testMain() {
        ...
        assertEquals(myHash.getTombstone().getStartPos(), -1);
        assertEquals(myHash.getMemManager().getMemPool().length, 32);
    ...
    public void testProbe() {
        ...
        assertEquals(myHash.getHashTable()[0].getStartPos(), 0);
     ...
     */
    public void testRepeatInsertAndRemove() {
